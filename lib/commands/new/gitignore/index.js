...
module.exports = {
  ...
  init: function (cmd) {
    ...
    gitignoreCmd
      .option("-l, --list", "list simple list of all available gitignore types")
      .parse();
    ...
    inquirer
      ...
      .then((answers) => {
        if (answers.type === "from github") {
            ...
            inquirer
              ...
              .then((a) => {
                ...
                if(a.giType.length === 0) {
                  utils.error("You need to select at least one gitignore type.");
                  utils.exit();
                }
          ...
          utils.log(answers);
          console.log(`.gitignore file of type '${answers.type}' in ${answers.path} created!`);
          utils.exit();
        }
      });
  },
